function exibe() {
	...
	if(comentario) document.getElementsByTagName('footer')[0].innerHTML = "<button onclick=\"location.href = '../../index.htm';\">home</button>";
	else document.getElementsByTagName('footer')[0].innerHTML = "<button onclick=\"(document.head || document.body).appendChild(s); comentario = true;\">comente</button> <button onclick=\"location.href = '../../index.htm';\">home</button>";
	window.scrollTo(0,0);
	Prism.highlightAll();
}
